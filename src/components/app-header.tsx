  ...
  return (
    <header className="sticky top-0 z-50 shadow-lg">
      <div className="bg-headerPrimary text-headerPrimary-foreground">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex-1 max-w-2xl px-6">
            <div className="relative">
              <Input
                ...
                className="bg-headerPrimary-foreground/10 text-headerPrimary-foreground border-headerPrimary-foreground/30 placeholder:text-headerPrimary-foreground/60 focus:bg-headerPrimary-foreground/20 focus:ring-offset-headerPrimary focus:ring-headerPrimary-foreground/50 h-10 pl-10 text-sm rounded-md"
              />
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button variant="ghost" size="icon" className="hover:bg-headerPrimary-foreground/10 text-headerPrimary-foreground rounded-full w-9 h-9">
            ...
            <Avatar className="h-9 w-9 ml-2 border-2 border-headerPrimary-foreground/50">
      ...
      <nav className="bg-headerSecondary text-headerSecondary-foreground shadow-inner">
        <div className="container mx-auto px-4 h-12 flex items-center justify-start space-x-1">
          {navItems.map((item) => (
            <Button 
              key={item.name} 
              variant="ghost" 
              className="text-sm font-medium hover:bg-headerPrimary-foreground/10 hover:text-headerPrimary-foreground px-3 py-2 h-auto rounded-md"
            >
              {item.name.toUpperCase()}
              {item.dropdown && <ChevronDown className="ml-1.5 h-4 w-4 opacity-70" />}
            </Button>
          ))}
        </div>
      </nav>
